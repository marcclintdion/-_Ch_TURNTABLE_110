...
void ProcessKeyboard(void)
{
   ...
   //=======================================================================================
    if (keys['L'])
    {
             hardShinyBumpPlastic_LIGHT_POSITION_01[0]         +=  1.15;
    }
    if (keys['J'])
    {
             hardShinyBumpPlastic_LIGHT_POSITION_01[0]         -=  1.15;
    ...
    if (keys['I'])
    {
             hardShinyBumpPlastic_LIGHT_POSITION_01[1]         += 1.15;
    } 
    if (keys['K'])
    {
             hardShinyBumpPlastic_LIGHT_POSITION_01[1]         -=  1.15;
    ...
    if (keys['O'])
    {
             hardShinyBumpPlastic_LIGHT_POSITION_01[2]         +=  1.15;
    }
    if (keys['U'])  
    {
             hardShinyBumpPlastic_LIGHT_POSITION_01[2]         -=  1.15;
    ...
    if (keys['X'])
    {
             shininess_hardShinyBumpPlastic                    +=  .11;
    }
    if (keys['Z'])
    {
             shininess_hardShinyBumpPlastic                    -=  .11;
